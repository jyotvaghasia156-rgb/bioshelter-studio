...
export const GLOBAL_SOIL_DIRECTORY = [
    ...
    {
        id: 'soil_kutch',
        name: 'Great Rann Saline Silt & Desert Dune Sand',
        taxonomy: 'Salorthidic Torripsamment (Aridisol)',
        district: 'Kutch / Bhuj & Great Rann, Gujarat',
        country: 'India',
        region: 'South Asia',
        natureCategory: 'arid_desert',
        natureTitle: '🏜️ Great Rann Saline Mineral Silt',
        k: 0.38,
        rho: 1620,
        cp: 850,
        ...
        bearingCapacity: 220,
        plasticityIndex: 3,
        earthShelterSuitability: 'Exceptional (Bhungas Mud Thermal Damping within 1.5m)',
        earthTubeCoolingPotential: '-10.5°C at 3.0m depth',
        bestTechniques: ['Circular Bhunga Mud-Lippan Walls', 'Earthbag SuperAdobe Domes', 'Lime-Saline Stabilized Blocks'],
        description: 'Fine quartz dune sand mixed with mineral evaporite salts. Damps extreme 45°C summer desert heatwaves with 14°C interior thermal cooling.',
        googleMapsUrl: 'https://www.google.com/maps/search/?api=1&query=23.2420,69.6669',
        lat: 23.2420,
        lng: 69.6669,
        photoUrl: 'https://images.unsplash.com/photo-1509316975850-ff9c5deb0cd9?w=600&auto=format&fit=crop&q=80'
    },
    {
        id: 'soil_ahmedabad',
        name: 'Sabarmati Basin Alluvial Goradu Silt',
        taxonomy: 'Udic Haplustept (Inceptisol)',
        district: 'Ahmedabad & Gandhinagar, Gujarat',
        country: 'India',
        region: 'South Asia',
        natureCategory: 'alluvial_loam',
        natureTitle: '🌾 Goradu Sandy Loam (Sabarmati Basin)',
        k: 0.92,
        rho: 1560,
        cp: 1150,
        diffusivityDay: 0.0442,
        moistureContent: 14,
        bearingCapacity: 195,
        plasticityIndex: 13,
        earthShelterSuitability: 'Optimal Natural Cohesion (Pol House Underground Tanka Cisterns)',
        earthTubeCoolingPotential: '-8.4°C at 3.0m depth',
        bestTechniques: ['Interlocking CSEB Bricks', 'Traditional Pol Brick-Lime Cavity Walls', 'Subterranean Cistern Excavation'],
        description: 'Fertile alluvial plain soil deposited by the Sabarmati river system. Excellent structural cohesion and unbaked adobe stability.',
    ...
    {
        id: 'soil_surat',
        name: 'Tapi Estuary Marine Black Silt Clay',
        taxonomy: 'Vertic Haplustept (Vertisol)',
        district: 'Surat & Bharuch, Gujarat',
        country: 'India',
        region: 'South Asia',
        natureCategory: 'expansive_clay',
        natureTitle: '🌊 Estuarine Marine Black Silt',
        k: 1.20,
        rho: 1740,
        cp: 1380,
        diffusivityDay: 0.0431,
        moistureContent: 25,
        bearingCapacity: 110,
        plasticityIndex: 40,
        earthShelterSuitability: 'High Volumetric Thermal Mass (Elevated Plinth Recommended)',
        earthTubeCoolingPotential: '-6.8°C at 3.0m depth',
        bestTechniques: ['Raised Timber Stilt Plinths', 'Lime-Stabilized Earthbag Bunds', 'Moisture-Barrier Retaining Walls'],
        description: 'Estuarine sediment rich in organic marine silts and montmorillonite clay. High moisture capacity provides steady seasonal thermal damping.',
        googleMapsUrl: 'https://www.google.com/maps/search/?api=1&query=21.1702,72.8311',
        lat: 21.1702,
        lng: 72.8311,
        photoUrl: 'https://images.unsplash.com/photo-1584905066893-7d5c142ba4e1?w=600&auto=format&fit=crop&q=80'
    },
    {
        id: 'soil_dang',
        name: 'Sahyadri Forest Lateritic Humic Clay',
        taxonomy: 'Plinthic Paleudult (Ultisol / Oxisol)',
        district: 'Dang / Saputara Hill Station, Gujarat',
        country: 'India',
        region: 'South Asia',
        natureCategory: 'tropical_laterite',
        natureTitle: '🌸 Sahyadri Montane Forest Laterite',
        k: 1.35,
        rho: 1840,
        cp: 1050,
        diffusivityDay: 0.0604,
        moistureContent: 22,
        bearingCapacity: 340,
        plasticityIndex: 18,
        earthShelterSuitability: 'Immense Natural Slope Stability (Hillside Berming Optimal)',
        earthTubeCoolingPotential: '-6.2°C at 3.0m depth',
        bestTechniques: ['Terraced Hillside Cut-and-Fill', 'Bamboo-Mud Composite Wattle', 'Laterite Block Foundations'],
        description: 'Rich dark red lateritic clay found in the Sahyadri teak forest hills of Saputara. Naturally resistant to water erosion from 2,500mm monsoon rains.',
    ...
    {
        id: 'soil_rajkot',
        name: 'Saurashtra Basaltic Black Trap Soil',
        taxonomy: 'Typic Chromustert (Vertisol)',
        district: 'Rajkot & Junagadh, Gujarat',
        country: 'India',
        region: 'South Asia',
        natureCategory: 'expansive_clay',
        natureTitle: '🧱 Saurashtra Basaltic Trap Soil',
        k: 1.22,
        rho: 1790,
        cp: 1360,
        ...
        bearingCapacity: 150,
        plasticityIndex: 36,
        earthShelterSuitability: 'Superb Thermal Mass against Saurashtra Arid Heat',
        earthTubeCoolingPotential: '-8.5°C at 3.0m depth',
        bestTechniques: ['Basalt Stone-Lime Hybrid Walls', 'Rammed Earth with Quarry Dust', 'Sub-Slab Geothermal Loops'],
        description: 'Deccan volcanic trap soil with exceptional thermal inertia, shielding against 43°C Saurashtra summer sun.',
        googleMapsUrl: 'https://www.google.com/maps/search/?api=1&query=22.3039,70.8022',
        lat: 22.3039,
        lng: 70.8022,
        photoUrl: 'https://images.unsplash.com/photo-1584905066893-7d5c142ba4e1?w=600&auto=format&fit=crop&q=80'
    },
    {
        id: 'soil_navsari',
        name: 'Navsari Coastal Alluvial Clay Loam & Orchard Silt',
        taxonomy: 'Fluventic Haplustept (Inceptisol)',
        district: 'Navsari & Purna River Basin, Gujarat',
        country: 'India',
        region: 'South Asia',
        natureCategory: 'alluvial_loam',
        natureTitle: '🌱 Coastal Orchard Alluvium & Silty Loam',
        k: 0.98,
        rho: 1650,
        cp: 1220,
        diffusivityDay: 0.0421,
        ...
        bearingCapacity: 210,
        plasticityIndex: 19,
        earthShelterSuitability: 'Excellent Workability & Moisture-Balanced Thermal Damping',
        earthTubeCoolingPotential: '-7.9°C at 3.0m depth',
        bestTechniques: ['Interlocking Soil-Cement Blocks', 'Rammed Earth with Agricultural Fiber', 'Raised Lime Plinth Foundations'],
        description: 'Rich fertile silt loam deposited across the Purna and Ambika river deltas. Exceptional for unbaked adobe and earthbag earth-tube cooling sinks.',
