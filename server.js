        ...
        if (pathname.startsWith('/api/')) {
            ...
            if (pathname === '/api/districts/live' || pathname === '/api/districts/temperature') {
                ...
                const rawDistricts = [
                    ...
                    { id: "gj_ahmedabad", name: "Ahmedabad", aliases: ["Ahmedabad City", "Amdavad", "Sanand", "Dholera"], state: "Gujarat", region: "North & Central Gujarat", lat: 23.0225, lng: 72.5714, baseTemp: 42.5, baseRh: 32, vernacular: "Pol house courtyard stack effect, Otla porches & Tanka cisterns." },
                    { id: "gj_surat", name: "Surat", aliases: ["Surat City", "Rander", "Bardoli", "Hazira"], state: "Gujarat", region: "South Gujarat Coastal", lat: 21.1702, lng: 72.8311, baseTemp: 36.8, baseRh: 78, vernacular: "Elevated timber stilt plinths & continuous cross-ventilation jharokhas." },
                    { id: "gj_vadodara", name: "Vadodara", aliases: ["Baroda", "Padra", "Savli", "Dabhoi"], state: "Gujarat", region: "North & Central Gujarat", lat: 22.3072, lng: 73.1812, baseTemp: 41.2, baseRh: 38, vernacular: "Thick brick-lime masonry with shaded arched colonnades." },
                    { id: "gj_rajkot", name: "Rajkot", aliases: ["Rajkot City", "Gondal", "Jetpur", "Jasdan"], state: "Gujarat", region: "Saurashtra & Kutch", lat: 22.3039, lng: 70.8022, baseTemp: 43.1, baseRh: 28, vernacular: "High thermal mass stone walls & reflective cool-roof coatings." },
                    { id: "gj_bhavnagar", name: "Bhavnagar", aliases: ["Bhavnagar Coast", "Palitana", "Mahuva", "Alang"], state: "Gujarat", region: "Saurashtra & Kutch", lat: 21.7645, lng: 72.1519, baseTemp: 38.5, baseRh: 62, vernacular: "Gulf of Khambhat sea breeze capture with shaded courtyard verandas." },
                    { id: "gj_jamnagar", name: "Jamnagar", aliases: ["Jamnagar Coast", "Dhrol", "Jodiya", "Kalavad"], state: "Gujarat", region: "Saurashtra & Kutch", lat: 22.4707, lng: 70.0577, baseTemp: 37.4, baseRh: 65, vernacular: "Marine lime plasters & deep eaves to resist coastal solar glare." },
                    { id: "gj_junagadh", name: "Junagadh", aliases: ["Junagadh Gir", "Girnar", "Keshod", "Mangrol"], state: "Gujarat", region: "Saurashtra & Kutch", lat: 21.5222, lng: 70.4579, baseTemp: 39.8, baseRh: 52, vernacular: "Girnar hill microclimate integration with shaded rock-cut thermal sinks." },
                    { id: "gj_gandhinagar", name: "Gandhinagar", aliases: ["Gandhinagar Capital", "Kalol", "Mansa", "GIFT City"], state: "Gujarat", region: "North & Central Gujarat", lat: 23.2156, lng: 72.6369, baseTemp: 42.0, baseRh: 30, vernacular: "Dense green canopy tree shading with wide cross-ventilated road axes." },
                    { id: "gj_kutch", name: "Kutch (Bhuj / White Rann)", aliases: ["Kutch", "Bhuj", "Gandhidham", "Mandvi", "Anjar", "Rann of Kutch"], state: "Gujarat", region: "Saurashtra & Kutch", lat: 23.2420, lng: 69.6669, baseTemp: 44.8, baseRh: 18, vernacular: "Circular Bhunga with conical thatched roofs & Lippan mud-mirror insulation." },
                    { id: "gj_banaskantha", name: "Banaskantha (Palanpur)", aliases: ["Banaskantha", "Palanpur", "Ambaji", "Deesa", "Dhanera"], state: "Gujarat", region: "North & Central Gujarat", lat: 24.1724, lng: 72.4346, baseTemp: 43.6, baseRh: 24, vernacular: "Rammed earth earth-sheltered subterranean berming against desert heatwaves." },
                    ...
                    { id: "gj_mehsana", name: "Mehsana", aliases: ["Mehsana", "Modhera", "Vadnagar", "Kadi", "Visnagar"], state: "Gujarat", region: "North & Central Gujarat", lat: 23.5880, lng: 72.3693, baseTemp: 42.8, baseRh: 29, vernacular: "Sunken courtyards with thick terracotta cavity wall construction." },
                    ...
                    { id: "gj_dahod", name: "Dahod", aliases: ["Dahod", "Devgadh Baria", "Garbada", "Limkheda"], state: "Gujarat", region: "North & Central Gujarat", lat: 22.8340, lng: 74.2555, baseTemp: 40.2, baseRh: 40, vernacular: "Wattle-and-daub organic mud walls with broad protective thatched eaves." },
                    { id: "gj_kheda", name: "Kheda (Nadiad)", aliases: ["Kheda", "Nadiad", "Kapadvanj", "Mehmedabad"], state: "Gujarat", region: "North & Central Gujarat", lat: 22.6916, lng: 72.8634, baseTemp: 41.8, baseRh: 35, vernacular: "Central chowk courtyards with perforated jali brick ventilation." },
                    { id: "gj_anand", name: "Anand (Milk Capital)", aliases: ["Anand", "Vallabh Vidyanagar", "Khambhat", "Petlad"], state: "Gujarat", region: "North & Central Gujarat", lat: 22.5645, lng: 72.9289, baseTemp: 41.6, baseRh: 36, vernacular: "Lush agrarian tree shelterbelts & passive double-roof air cavities." },
                    { id: "gj_chhota_udeypur", name: "Chhota Udaipur", aliases: ["Chhota Udaipur", "Bodeli", "Sankheda"], state: "Gujarat", region: "North & Central Gujarat", lat: 22.3082, lng: 74.0136, baseTemp: 39.5, baseRh: 44, vernacular: "Pithora mud-plastered walls with earthen breathable floor envelopes." },
                    { id: "gj_narmada", name: "Narmada (Rajpipla / Kevadia)", aliases: ["Narmada", "Rajpipla", "Kevadia", "Statue of Unity"], state: "Gujarat", region: "South Gujarat Coastal", lat: 21.8708, lng: 73.5027, baseTemp: 38.6, baseRh: 55, vernacular: "Narmada valley canyon breezes & river cooling air-induction shafts." },
                    { id: "gj_bharuch", name: "Bharuch", aliases: ["Bharuch", "Ankleshwar", "Dahej", "Jambusar"], state: "Gujarat", region: "South Gujarat Coastal", lat: 21.7051, lng: 72.9959, baseTemp: 37.8, baseRh: 70, vernacular: "High-humidity cross-ventilation louvers & saline-resistant lime finishes." },
                    ...
                    { id: "gj_porbandar", name: "Porbandar", aliases: ["Porbandar", "Ranavav", "Kutiyana"], state: "Gujarat", region: "Saurashtra & Kutch", lat: 21.6417, lng: 69.6293, baseTemp: 35.2, baseRh: 74, vernacular: "White Porbandar limestone blocks with high thermal reflectance & salt durability." },
                    { id: "gj_dwarka", name: "Devbhumi Dwarka (Khambhalia)", aliases: ["Devbhumi Dwarka", "Dwarka", "Khambhalia", "Okha"], state: "Gujarat", region: "Saurashtra & Kutch", lat: 22.2442, lng: 68.9685, baseTemp: 34.6, baseRh: 76, vernacular: "Strong coastal wind turbines & marine lime thick stone construction." },
                    { id: "gj_gir_somnath", name: "Gir Somnath (Veraval)", aliases: ["Gir Somnath", "Veraval", "Somnath", "Talala Gir", "Gir Forest"], state: "Gujarat", region: "Saurashtra & Kutch", lat: 20.9000, lng: 70.3667, baseTemp: 34.8, baseRh: 75, vernacular: "Arabian sea humidity relief with high-volume ocean breeze cross-ducting." },
                    { id: "gj_amreli", name: "Amreli", aliases: ["Amreli", "Dhari", "Rajula", "Jafrabad"], state: "Gujarat", region: "Saurashtra & Kutch", lat: 21.6032, lng: 71.2221, baseTemp: 42.0, baseRh: 35, vernacular: "Dense stone plinths with nocturnal sky radiation cooling roofs." },
                    { id: "gj_botad", name: "Botad", aliases: ["Botad", "Gadhada", "Barwala"], state: "Gujarat", region: "Saurashtra & Kutch", lat: 22.1700, lng: 71.6600, baseTemp: 42.4, baseRh: 32, vernacular: "Massive compressed stabilized earth blocks (CSEB) with internal air shafts." },
                    { id: "gj_morbi", name: "Morbi", aliases: ["Morbi", "Wankaner", "Maliya Miyana"], state: "Gujarat", region: "Saurashtra & Kutch", lat: 22.8173, lng: 70.8377, baseTemp: 43.0, baseRh: 30, vernacular: "High-albedo ceramic cool-roof tiles with double-skin vented facades." },
                    { id: "gj_surendranagar", name: "Surendranagar (Zalawad)", aliases: ["Surendranagar", "Wadhwan", "Dhrangadhra", "Limbdi"], state: "Gujarat", region: "Saurashtra & Kutch", lat: 22.7275, lng: 71.6370, baseTemp: 44.0, baseRh: 22, vernacular: "Thick stone cavity insulation to combat extreme diurnal desert variations." },

                    // Indian Metros & Regions
                    { id: "in_delhi", name: "New Delhi Central", aliases: ["Delhi", "NCR", "Noida", "Gurgaon"], state: "Delhi NCR", region: "Major Indian Metro Districts", lat: 28.6139, lng: 77.2090, baseTemp: 43.8, baseRh: 32, vernacular: "Jali screens, Mughal water channel cooling & thick brick cavity walls." },
                    { id: "in_mumbai", name: "Mumbai Suburban", aliases: ["Mumbai", "Bombay", "Thane", "Navi Mumbai"], state: "Maharashtra", region: "Major Indian Metro Districts", lat: 19.0760, lng: 72.8777, baseTemp: 34.5, baseRh: 82, vernacular: "High ceiling double-pitch roofs with maximum cross-ventilation louvers." },
                    { id: "in_bengaluru", name: "Bengaluru Urban", aliases: ["Bangalore", "Bengaluru", "Electronic City"], state: "Karnataka", region: "Major Indian Metro Districts", lat: 12.9716, lng: 77.5946, baseTemp: 28.4, baseRh: 55, vernacular: "Year-round temperate Goldilocks climate with open bioclimatic verandas." },
                    { id: "in_chennai", name: "Chennai Central", aliases: ["Chennai", "Madras", "OMR", "Adyar"], state: "Tamil Nadu", region: "Major Indian Metro Districts", lat: 13.0827, lng: 80.2707, baseTemp: 37.6, baseRh: 78, vernacular: "Thinnai entrance verandas with ventilated terra-cotta Madras terrace roofs." },
                    { id: "in_hyderabad", name: "Hyderabad Urban", aliases: ["Hyderabad", "Cyberabad", "Secunderabad"], state: "Telangana", region: "Major Indian Metro Districts", lat: 17.3850, lng: 78.4867, baseTemp: 40.5, baseRh: 38, vernacular: "Granite stone thermal mass with subterranean passive cooling basements." },
                    { id: "in_kolkata", name: "Kolkata Metropolitan", aliases: ["Kolkata", "Calcutta", "Howrah"], state: "West Bengal", region: "Major Indian Metro Districts", lat: 22.5726, lng: 88.3639, baseTemp: 36.2, baseRh: 84, vernacular: "Slatted louvered green shutters (Khadkhadi) & deep shaded balconies." },
                    ...
                    { id: "in_jodhpur", name: "Jodhpur (Sun City)", aliases: ["Jodhpur", "Blue City"], state: "Rajasthan", region: "Major Indian Metro Districts", lat: 26.2389, lng: 73.0243, baseTemp: 44.5, baseRh: 20, vernacular: "Indigo blue lime wash reflecting 78% solar radiation with shaded alleys." },
                    ...
                    { id: "in_udaipur", name: "Udaipur (City of Lakes)", aliases: ["Udaipur", "Lake Pichola"], state: "Rajasthan", region: "Major Indian Metro Districts", lat: 24.5854, lng: 73.7125, baseTemp: 39.5, baseRh: 45, vernacular: "Water evaporative cooling corridors & white marble thermal sinks." },
                    { id: "in_ladakh", name: "Leh Ladakh", aliases: ["Leh", "Ladakh", "Nubra Valley"], state: "Ladakh", region: "Major Indian Metro Districts", lat: 34.1526, lng: 77.5771, baseTemp: 14.5, baseRh: 25, vernacular: "Trombe walls, direct solar gain sunrooms & thick timber straw-clay insulation." },
                    { id: "in_srinagar", name: "Srinagar (Kashmir Valley)", aliases: ["Srinagar", "Kashmir", "Dal Lake"], state: "Jammu & Kashmir", region: "Major Indian Metro Districts", lat: 34.0837, lng: 74.7973, baseTemp: 22.0, baseRh: 58, vernacular: "Dhajji Dewari timber-masonry with Hamam subterranean floor heating." },
                    { id: "in_shimla", name: "Shimla", aliases: ["Shimla", "Himachal"], state: "Himachal Pradesh", region: "Major Indian Metro Districts", lat: 31.1048, lng: 77.1734, baseTemp: 21.5, baseRh: 62, vernacular: "Kath-Kuni stone-wood interlocking architecture with direct passive solar heating." },
                    ...
                    { id: "in_goa", name: "Goa Coastal", aliases: ["Goa", "Panaji", "Margao"], state: "Goa", region: "Major Indian Metro Districts", lat: 15.2993, lng: 74.1240, baseTemp: 33.0, baseRh: 82, vernacular: "Indo-Portuguese balcões (wrap-around verandas), red laterite stone & oyster windows." },
                ...
                if (stateFilter && stateFilter !== 'all') {
                    ...
                    else if (stateFilter.includes('north') || stateFilter.includes('central')) list = list.filter(d => d.region.includes('North & Central'));
                    else if (stateFilter === 'india' || stateFilter === 'national') list = list.filter(d => d.region.includes('Major Indian Metro'));
                    else if (stateFilter === 'global' || stateFilter === 'world') list = list.filter(d => d.region.includes('Global Metropolitan'));
                }

                if (q) {
                    let matched = list.filter(d => d.name.toLowerCase().includes(q) || d.region.toLowerCase().includes(q) || d.state.toLowerCase().includes(q) || d.vernacular.toLowerCase().includes(q) || (d.aliases && d.aliases.some(a => a.toLowerCase().includes(q))));
                    if (matched.length === 0) {
                        matched = rawDistricts.filter(d => d.name.toLowerCase().includes(q) || d.region.toLowerCase().includes(q) || d.state.toLowerCase().includes(q) || d.vernacular.toLowerCase().includes(q) || (d.aliases && d.aliases.some(a => a.toLowerCase().includes(q))));
                    }
                    list = matched;
                }
